...
namespace LeaveApplication.Controllers
{
    ...
    public class RolesController : Controller
    {
        ...
        [HttpPost]
        //public async Task<ActionResult> Create(Role roleViewModel)
        ...
        //public async Task<ActionResult> Edit([Bind(Include = "Name,Id")] Role roleModel)
        public async Task<ActionResult> Edit([Bind(Include = "Name,Id,Description")] ApplicationRole roleModel)
        {
            if (ModelState.IsValid)
            {
